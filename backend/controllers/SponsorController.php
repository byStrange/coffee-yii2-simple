...
use common\models\search\SponsorSearch;
...
class SponsorController extends Controller
{
  ...
  public function actionCreate()
  {
    ...
    if ($this->request->isPost) {
      if ($model->load($this->request->post())) {
        $uploaded_file = UploadedFile::getInstance($model, 'image_path_upload');
        $model->upload($uploaded_file);
  ...
  {
    if (($model = Sponsor::findOne(['id' => $id])) !== null) {
      return $model;
    }
